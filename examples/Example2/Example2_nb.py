...
cal_grav_4.theta.plots.plot(['boxplot', 'histogram'], whichtheta = [0])
...
'''
cal_lin_1.theta.plots.plot(['boxplot', 'histogram'], whichtheta = [0])
cal_lin_2.theta.plots.plot(['boxplot', 'histogram'], whichtheta = [0])
cal_lin_3.theta.plots.plot(['boxplot', 'histogram'], whichtheta = [0])
cal_lin_4.theta.plots.plot(['boxplot', 'histogram'], whichtheta = [0])
cal_lin_1.theta.plots.plot(['boxplot', 'histogram','density'], subplot = "transpose" ,whichtheta =  [0,1])
